...
fn main() {
    ...
    let e5 = Box::new(Exp::Lam(String::from("x"),Box::new(Exp::App(Box::new(Exp::Var(String::from("x"))),Box::new(Exp::Var(String::from("x")))))));

    let mut state = (Exp::App(e5.clone(),e5),env,Continuation::Done);
